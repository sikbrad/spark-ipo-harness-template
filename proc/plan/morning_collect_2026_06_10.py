#!/usr/bin/env python3
"""Collect morning live sources for 2026-06-10.

This reuses the date-scoped night routine collector functions, but writes into
the 2026-06-10 daily raw directory and skips the heavy Notion dump step.
"""
...
SRC = BASE / "night_routine_collect_2026_06_09.py"
...
mod.DAY = "2026-06-10"
mod.NEXT_DAY = "2026-06-11"
mod.RAW = Path("data/daily/2026-06-10/raw")
