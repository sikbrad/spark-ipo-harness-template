#!/usr/bin/env python3
"""Collect morning live sources for 2026-06-12.

This reuses the date-scoped night routine collector functions, but writes into
the 2026-06-12 daily raw directory and skips the heavy Notion dump step.
"""
...
mod.DAY = "2026-06-12"
mod.NEXT_DAY = "2026-06-13"
mod.RAW = Path("data/daily/2026-06-12/raw")
