...
Input  : backfill_areas_2026-06-05.mapping.json  (or path passed as argv[0])
Output : backfill_areas_2026-06-05.result.json
...
Usage:
    python proc/plan/backfill_areas_2026-06-05.py [mapping.json] [--dry-run]
"""
...
def main(argv: list[str]) -> int:
    ...
    mapping_path = (
        ...
        else Path(__file__).with_suffix("").parent / "backfill_areas_2026-06-05.mapping.json"
    )
