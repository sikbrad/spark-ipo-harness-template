...
- `.claude/skills/teams-chatrooms/dump_chatrooms.py` — 본 스킬 entrypoint
...
python3 .claude/skills/teams-chatrooms/dump_chatrooms.py

# 다른 경로
python3 .claude/skills/teams-chatrooms/dump_chatrooms.py --out output/teams_chats_2026-05.md

# 마크다운 + 원본 JSON 동시 저장
python3 .claude/skills/teams-chatrooms/dump_chatrooms.py --json data/teams/chatrooms_list.json
```
